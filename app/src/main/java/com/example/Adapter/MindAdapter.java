...
public class MindAdapter extends RecyclerView.Adapter<MindAdapter.ViewHolder> {
    ...
    public MindAdapter(ArrayList<youtube> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public MindAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.youtube,parent,false);
        return new MindAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MindAdapter.ViewHolder holder, int position) {
